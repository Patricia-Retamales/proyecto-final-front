...
const CardTajetas = () => {
  ...
  return (
    <div className="row">
      ...
      <Card style={{ width: '18rem', height: "25rem", margin:"25px"  }}>
        <Card.Img variant="top" src="https://http2.mlstatic.com/D_NQ_NP_754908-MLA44492091518_012021-O.jpg"
          style={{ height: "13rem" }}
        />
        <Card.Body>
          <Card.Title>Cupcake Paradise</Card.Title>
          <Card.Text>
            <p>Detalles:se realiza todo tipo de tortas personalizadas</p>
            <p>Contactos: +569 12345678 </p>
