		...
		actions: {
			...
			getMessage: async () => {
				try {
					...
					const resp = await fetch("https://3000-sneelyg-proyectofinalba-pr1tbjybzwf.ws-us74.gitpod.io" + "/api/hello")
			...
			registro_funcion: (registro) => {
				...
				fetch("https://3000-sneelyg-proyectofinalba-pr1tbjybzwf.ws-us74.gitpod.io/registro", requestOptions)
			...
			login_function: (login) => {
				...
				fetch("https://3000-sneelyg-proyectofinalba-pr1tbjybzwf.ws-us74.gitpod.io/login", requestOptions)
					.then(response => response.json())
					.then(result => {
						console.log(result)
			...
			crear_producto_funcion: (datos_producto) => {
				...
				fetch("https://3000-sneelyg-proyectofinalba-pr1tbjybzwf.ws-us74.gitpod.io/productos/registro", requestOptions)
			...
			getProductos: () => {
				...
				fetch("https://3000-sneelyg-proyectofinalba-pr1tbjybzwf.ws-us74.gitpod.io/productos/", requestOptions)
					.then(response => response.text())
			...
			getMarcas: () => {
				...
				fetch("https://3000-sneelyg-proyectofinalba-pr1tbjybzwf.ws-us74.gitpod.io/marcas", requestOptions)
					.then(response => response.text())
			...
			acceso_privado: () => {
				...
				fetch("https://3000-sneelyg-proyectofinalba-pr1tbjybzwf.ws-us74.gitpod.io/privada", requestOptions)
					.then(response => response.json())
					.then(result => {
			...
			borrar_producto_funcion: (id_producto) => {
				...
				fetch("https://3000-sneelyg-proyectofinalba-pr1tbjybzwf.ws-us74.gitpod.io/productos/" + id_producto, requestOptions)
					.then(response => response.text())
					.then(result => console.log(result))
					.catch(error => console.log('error', error));
			},
			...
			recuperar_clave_funcion: (email_usuario, telefono) => {
				...
				fetch("https://3000-sneelyg-proyectofinalba-pr1tbjybzwf.ws-us74.gitpod.io/recuperar/clave", requestOptions)
					.then(response => response.json())
					.then(result => console.log(result))
					.catch(error => console.log('error', error));
			...
			cambiar_clave_funcion: (nueva_clave, vieja_clave) => {
				...
				fetch("https://3000-sneelyg-proyectofinalba-pr1tbjybzwf.ws-us74.gitpod.io/cambiar/clave", requestOptions)
					.then(response => response.json())
					.then(result => {
						console.log(result)
